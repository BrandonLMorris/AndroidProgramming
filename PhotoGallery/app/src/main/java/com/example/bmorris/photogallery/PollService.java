...
public class PollService extends IntentService {
    ...
    private static final int POLL_INTERNAL = 1000 * 15; //15 seconds
    public static final String PREF_IS_ALARM_ON = "isAlarmOn";

    public static final String ACTION_SHOW_NOTIFICATION = "com.example.bmorris.photogallery.SHOW_NOTIFICATION";

    public static final String PERM_PRIVATE = "com.bmorris.android.photogallery.PRIVATE";
