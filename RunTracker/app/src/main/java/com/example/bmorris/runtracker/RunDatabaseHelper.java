...
public class RunDatabaseHelper extends SQLiteOpenHelper {
    ...
    public RunCursor queryRuns() {
        //Equivalent to the "select * from run order by start_date asc"
    ...
    public LocationCursor queryLastLocationForRun(long runId) {
        Cursor wrapped = getReadableDatabase().query(TABLE_LOCATION,
                ...
                new String[]{String.valueOf(runId)}, //group by
                null, //group by
                null, //having
    ...
    public static class RunCursor extends CursorWrapper {
        ...
        //Returns a Run object configured for the current row, or null if the current row
        //is invalid.
        public Run getRun() {
    ...
    public RunCursor queryRun(long id) {
        Cursor wrapped = getReadableDatabase().query(TABLE_RUN,
                null, //all columns
                COLUMN_RUN_ID + " = ?", //Look for a runId
